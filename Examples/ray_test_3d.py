...
ax.scatter(ray_O[0]['lat'][0], np.mod(ray_O[0]['lon'][0],360), ray_O[0]['height'][0], zdir='z', c= 'b', label = 'O Mode',linewidth=7, linestyle=':', marker='.', s=symsize)
ax.scatter(ray_X[0]['lat'][0], np.mod(ray_X[0]['lon'][0],360), ray_X[0]['height'][0], zdir='z', c= 'r', label= 'X Mode',linewidth=7, linestyle=':', marker='.', s=symsize)
ax.scatter(ray_N[0]['lat'][0], np.mod(ray_N[0]['lon'][0],360), ray_N[0]['height'][0], zdir='z', c= 'g', label = 'No Mag-field', linewidth=7, linestyle=':', marker='.', s=symsize)
...
for i in range(0,num_elevs,2):
      ...
      ax.scatter(ray_N[i]['lat'], np.mod(ray_N[i]['lon'],360), ray_N[i]['height'], zdir='z', c= 'g', linewidth=0.3, linestyle=':', marker='.', s=symsize)
