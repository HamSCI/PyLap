...
height_inc = 1          #M height increment (km)
num_heights =800       #M number of  heights (must be < 2000)
...
sami_options = {
               'data_path': '/home/devindiehl/NetCDF/sami3_dene_G.nc',
              }   # py
print('Generating ionospheric grid... ')

filepath = "/home/devindiehl/NetCDF/sami3_dene_G.nc"

# SamiParams = Ionosphere.SAMI3Params(origin_lat, origin_long, R12, UT, ray_bear,
#              max_range, num_range, range_inc, start_height,
# 		     height_inc, num_heights, kp, doppler_flag,filepath)

iono_pf_grid = gen_iono.gen_iono_grid_SAMI3_2d(origin_lat, origin_long, R12, UT, ray_bear,
             max_range, num_range, range_inc, start_height,
		     height_inc, num_heights, kp, doppler_flag,filepath)
...
iono_en_grid_5 = np.zeros(iono_en_grid.shape)
collision_freq = np.zeros(iono_en_grid.shape)
print(iono_en_grid.shape)
irreg=np.zeros((4,800))
